                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: FlatButton(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: Colors.blue[100], fontSize: 20.0),
                                ),
                            ...
                            Container(
                              child: RaisedButton(
                                  onPressed: () async {
                                    Login retorno = await LoginApi.postLogin(
                                        login.text, senha.text);

                                    var prefs =
                                        await SharedPreferences.getInstance();
                                    final token =
                                        prefs.getString('tokenjwt') ?? '';
                                    if (retorno.login) {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
  ...
  Widget _constroiTextField(String labelText) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon:
            labelText == "Usuário" ? Icon(Icons.mail,color: Colors.black,) : Icon(Icons.lock,color: Colors.black),
